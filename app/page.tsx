  ...
  const phases = useMemo<Phase[]>(
    () => {
      ...
      },
      {
        ...
        subtitle: `Starter ${starterPercent}% · คาดว่าพร้อม ${duration(bulkReadiness.windowStart)}–${duration(bulkReadiness.windowEnd)} หลังเริ่มหมัก`,
        ...
        guide: [
          ...
          `ระบบคำนวณจาก Starter ${starterPercent}% + อุณหภูมิ${adaptiveTempSource === "dough" ? "กลางโดว์ที่วัดจริง" : "ห้อง"} ${fermentationTemperature}°C · ก่อนถึงขั้นตอนนี้หมักไปแล้วประมาณ ${duration(bulkElapsedBeforePhaseFour)}`,
    ...
    <main data-active-page={activePage}>
      ...
      <section className="section shell" id="recipe" hidden={activePage !== "recipe"}>
        ...
        <div className="recipe-grid">
          <div className="control-card" id="recipe-editor">
            ...
            <div className="dough-weight-editor">
              <div className="dough-weight-title">
                <span>น้ำหนักโดว์ต่อโลฟ</span>
                <strong>{targetDough.toLocaleString("th-TH")} กรัม</strong>
              </div>
              <div className="dough-weight-row">
                <select
                  aria-label="เลือกน้ำหนักโดว์ต่อโลฟ"
                  value={[600, 800, 950, 1000, 1200].includes(targetDough) ? String(targetDough) : "custom"}
                  onChange={(e) => {
                ...
                >
                  ...
                  <option value="1000">1,000 กรัม</option>
                  <option value="1200">1,200 กรัม</option>
      ...
      <section className="section shell" id="assistant" hidden={activePage !== "workflow"}>
        <header>
          ...
          <span>
            {bakePlan
              ? "แสดงวันและเวลาเริ่ม–เสร็จจากแผนเวลาอบที่เลือกไว้ด้านบน และคำนวณใหม่อัตโนมัติเมื่อ Starter หรืออุณหภูมิเปลี่ยน"
        ...
        <div className="workflow-style-banner">
          ...
          <div>
            <span>Starter ที่ใช้คำนวณ</span>
            <strong>{starterPercent}%</strong>
            <small>เปลี่ยนค่าแล้ว Workflow จะคำนวณเวลาใหม่</small>
          </div>
